...
export const RequestQuotePrompt = ({
  ...
  const t = locale === "fa"
    ? { title: "درخواست پیش‌فاکتور", login: "وارد شوید", join: " یا ", register: "حساب بسازید", add: "محصولات را به سبد خرید اضافه کنید", request: "سبد خرید را باز کنید و «درخواست پیش‌فاکتور» را بزنید", status: "وضعیت درخواست و پاسخ‌های فروشنده را از بخش پیش‌فاکتورها در حساب کاربری دنبال کنید." }
    : { title: "Request a quote", login: "Log in", join: " or ", register: "create an account", add: "Add products to your cart", request: "Open the cart and select “Request a quote”", status: "Track the request status and seller responses in the Quotes section of your account." }
