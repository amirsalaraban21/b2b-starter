        ...
        {!items.length ? (
          ...
          <>
            ...
            <div className="shrink-0 border-t border-slate-200 bg-slate-50/90 px-5 py-5 dark:border-slate-800 dark:bg-slate-900/80">
              <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1"><span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{fa ? "جمع کالاها" : "Subtotal"}</span><span className="max-w-full break-words text-xl font-black text-slate-950 dark:text-white" aria-live="polite">{formattedSubtotal}</span></div>
